...
function carregarProdutos() {
    ...
    produtos.forEach((produto) => {
        ...
        const imgTag = produto.imagem ? `<img src="${produto.imagem}" alt="${produto.nome}">` : '<img src="https://via.placeholder.com/50" alt="Imagem Padrão">'; // Imagem padrão se não houver
        li.innerHTML = `
            ${imgTag}
...
function adicionarProduto() {
    ...
    const novaImagem = inputImagem.value.trim() || "https://via.placeholder.com/50"; // Imagem padrão
